...
<p align="center">
First, the FIM must locate the file to be scanned. A specific file can be selected using the <u>open()</u> function - I have specified the text file <i>confidential.txt</i> in the parameters: <br/>
