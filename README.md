...
<p align="center">
First, the FIM must locate the target file. A specific file can be selected using the <u>open()</u> function - I have specified the text file <i>confidential.txt</i> to be opened and read: <br/>
